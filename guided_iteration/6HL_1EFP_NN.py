...
if __name__ == "__main__":
    main_efp_file = (
        path / "results" / "supplemental" / "p0" / "dif_order_ado_comparison.csv"
    )
    main_efps = list(pd.read_csv(main_efp_file, index_col=0).iloc[:10].efp.values)
    other_efps = [
        "EFP_1_0_0_k_0.5_b_0.5",
        "EFP_1_0_0_k_0_b_0.5",
        "EFP_1_0_0_k_2_b_0.5",
        "EFP_5_8_180_k_1_b_2",
        "EFP_6_8_335_k_2_b_0.5",
        "EFP_2_1_0_k_2_b_0.5",
        "EFP_8_7_1_k_0_b_1",
        "EFP_5_7_81_k_-1_b_2",
    ]
    ...
    best_kb = [
        "EFP_4_8_60_k_-1_b_0.5",
        "EFP_6_7_12_k_-1_b_1",
        "EFP_5_7_81_k_-1_b_2",
        "EFP_2_1_0_k_0_b_0.5",
        "EFP_8_7_1_k_0_b_1",
        "EFP_2_1_0_k_0_b_2",
        "EFP_6_7_1_k_0.5_b_0.5",
        "EFP_6_7_105_k_0.5_b_1",
        "EFP_2_1_0_k_0.5_b_2",
        "EFP_6_5_0_k_1_b_0.5",
        "EFP_6_7_12_k_-1_b_1",
        "EFP_5_7_81_k_-1_b_2",
