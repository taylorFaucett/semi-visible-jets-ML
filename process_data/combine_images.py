    ...
    for jet_type in jet_types:
        ...
        if not hf_file.exists():
            ...
            for jet_img in tqdm.tqdm(list(pathlib.Path(jet_file).rglob("*.h5"))):
                ...
                trim_jet = pd.read_pickle(hf_file.parent.parent / "trimmed_jets" / jet_type / f"{jet_img.stem}.pkl")
                if len(jet_images) <= 0:
            ...
            with open(hf_file.parent.parent / "trimmed_jets" / f"trimmed_jet-{jet_type}.pkl", 'wb') as f:
